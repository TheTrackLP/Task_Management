<div class="container-fluid">
    <div class="modal fade" tabindex="-1" id="addprjTask" role="document" data-bs-keyboard="false"
        data-bs-backdrop="static">
        <div class="modal-dialog modal-xl" role="dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h3>Add new Task for: {{ $projects->prj_name }}</h3>
                </div>
                <form action="{{ route('add.tasks') }}" method="post">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-4">
                                <div class="mb-3">
                                    <input type="hidden" name="prj_id" value="{{ $projects->id }}">
